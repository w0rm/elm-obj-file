...
![The “Pod” model by Kolja Wilcke](https://unsoundscapes.com/elm-obj-file/1.4.0/examples/pod.png)

_The “Pod” model by [@01k](https://mobile.twitter.com/01k) rendered with `elm-3d-scene`. [See it live here](https://unsoundscapes.com/elm-obj-file/1.4.0/examples/pod/)._

Make sure to check [the viewer example](https://unsoundscapes.com/elm-obj-file/1.4.0/examples/viewer/) that lets you preview OBJ files. [The Nefertiti example](https://unsoundscapes.com/elm-obj-file/1.4.0/examples/nefertiti/) demonstrates support for loading bumpy faces with a normal map texture.

The examples source code [can be found here](https://github.com/w0rm/elm-obj-file/tree/a9835991d7e341ff7967ad5c62944133d6072e06/examples).
