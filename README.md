...
![The “Pod” model by Kolja Wilcke](https://unsoundscapes.com/elm-obj-file/1.3.1/examples/pod.png)

_The “Pod” model by [@01k](https://mobile.twitter.com/01k) rendered with `elm-3d-scene`. [See it live here](https://unsoundscapes.com/elm-obj-file/1.3.1/examples/pod/)._

Make sure to check [the viewer example](https://unsoundscapes.com/elm-obj-file/1.3.1/examples/viewer/) that lets you preview OBJ files. [The Nefertiti example](https://unsoundscapes.com/elm-obj-file/1.3.1/examples/nefertiti/) demonstrates support for loading bumpy faces with a normal map texture.

The examples source code [can be found here](https://github.com/w0rm/elm-obj-file/tree/add288e514c83a25ec7c3e741b13120983e56834/examples).
