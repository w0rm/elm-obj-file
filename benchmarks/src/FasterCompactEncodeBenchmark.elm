module FasterCompactEncodeBenchmark exposing (main)
...
main =
    program <|
        Benchmark.compare "encodeCompact"
            "old texturedTriangles"
            (\_ -> Encode.encodeCompact Length.inMeters [ Encode.texturedTriangles mesh ])
            "texturedTriangles"
            (\_ -> Obj.Encode.encodeCompact Length.inMeters [ Obj.Encode.texturedTriangles mesh ])
